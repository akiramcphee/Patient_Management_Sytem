...
<?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true): ?>
    <html>
        ...
        <div class = "form_background">
                    <div class="line"></div>     
                    <div class="form_title">Enter New Med Record</div>
            ...
            <!-- Temporary form but with same fields as final -->
            <!-- Include div below for each field which needs validation-->
            <form id = "med_status_form" method = "post" onsubmit = "validInfo()" action = "../php/med_status_success.php" target = "blank">
            ...
            <!-- Time of Day -->  
            <label class = "reg_input_field"for="time_of_day"> Time of Day </label><br>
            <select class = "select_form_meal" id="time_of_day" name="time_of_day">
            ...
            <!-- Med ID --> 
            <label class = "reg_input_field" for="med_name"> Med_Name:</label><br>
            <input class="input_field_text"type="text" id="med_name" name="med_name"><br>
            <div class = "input_comment">
                <p id = "med_name_input_comment" style = "margin:0"></p>
            </div>
