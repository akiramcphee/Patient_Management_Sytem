...
<?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true): ?>
    ...
    <title>Med Regime</title>
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <link href="https://fonts.googleapis.com/css?family=Montserrat&display=swap" rel="stylesheet" />
    <link rel='stylesheet' type='text/css' media='screen' href='../css/med_regime.css'>
    </head>
    <body>
        <!-- navbar -->
        ...
        <div class="logo"></div>
        <div class="table_bgd">
            <span class="table_title">Medicine Regime</span>
            <div class="line"></div>
        ...
        <div class="Patient_table">
            <table id = "Patient_table" border="1" cellpadding="5">
                ...
                <!-- need to make this so rows are added when new med plan is added!-->
            </table>
        </div>
    </body>
</html>
